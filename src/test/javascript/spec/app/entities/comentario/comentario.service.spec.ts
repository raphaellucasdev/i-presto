    ...
    describe('Comentario Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/comentarios';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Comentario', () => {
                service.create(new Comentario(null)).subscribe(received => {
            ...
            it('should update a Comentario', () => {
                service.update(new Comentario(123)).subscribe(received => {
