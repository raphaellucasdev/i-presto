    ...
    describe('Anuncio Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/anuncios';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Anuncio', () => {
                service.create(new Anuncio(null)).subscribe(received => {
            ...
            it('should update a Anuncio', () => {
                service.update(new Anuncio(123)).subscribe(received => {
