...
describe('Service Tests', () => {
    describe('Prestador Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PrestadorService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/prestadors';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Prestador', () => {
                service.create(new Prestador(null)).subscribe(received => {
            ...
            it('should update a Prestador', () => {
                service.update(new Prestador(123)).subscribe(received => {
